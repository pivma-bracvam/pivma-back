...
**Storage**: PostgreSQL/pgvector existente; uma nova linha em `permissions` e uma nova linha em `access_profile_permissions`, sem mudança de schema
...
```text
migrations/versions/
└── <nova_revisao>_admin_user_listing_permission.py
